        ...
        <div class="container-fluid card-body">
            <form method="post" action="<?= base_url('berita/add'); ?>" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input autocomplete="off" autofocus placeholder="Masukkan Judul Berita" required type="text" class="form-control" id="judul" name="judul">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="foto" class="col-sm-2 col-form-label label">Foto</label>
                    <div class="col-sm-2">
                        <img class="img-thumbnail img-preview" src="/berita/no_image.png" alt="">
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="col-sm-10">
                        <div class="card card-outline card-info">
                            ...
                            <div class="card-body pad">
                                <div class="mb-3">
                                    <textarea name="isi" id="isi" class="textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
